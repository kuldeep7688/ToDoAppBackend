...
SQLALCHEMY_DATABASE_URL = "postgresql://postgres:nokia7688@localhost/TodoApplicationDatabase"

engine = create_engine(
    SQLALCHEMY_DATABASE_URL,
    # we will only allow one thread to communicate with SQL
    # assuming that each thread handles an independent request
    # to prevent any type of accidental sharing of the same connection between
    # different request
